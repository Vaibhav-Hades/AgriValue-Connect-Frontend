  ...
  return (
    <div className="space-y-5">
      <div>
        ...
        <p className="text-gray-500 mt-1">Track all your product orders</p>
      </div>
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              <thead className="bg-gray-50">
                <tr>
                  {['Order ID', 'Product', 'Buyer', 'Quantity', 'Total', 'Status', 'Date'].map(h => (
              ...
              <tbody className="divide-y divide-gray-50">
                {orders.map((order, i) => (
                  <motion.tr key={order.id} initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: i * 0.04 }}
                    ...
                    <td className="py-4 px-4 text-gray-700">{order.productName}</td>
